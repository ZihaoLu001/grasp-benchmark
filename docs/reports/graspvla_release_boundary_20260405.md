...
| --- | --- | --- | --- | --- | --- | --- | --- |
| V0_official_runner vs V0_repeat_official_runner | 25 | 25 | 25 | 25 | 3 | 3 | libero_goal__task001__seed001, libero_goal__task001__seed002, libero_goal__task001__seed006 |
| V0_official_runner vs V1_wrapper_official_parity | 25 | 25 | 25 | 25 | 2 | 2 | libero_goal__task001__seed002, libero_goal__task001__seed004 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| V0_official_runner | official_aligned_sim | official_alignment_subset | 20 | 19 | 0.95 | 5 | 0 | 0.0 |  |
| V0_repeat_official_runner | official_aligned_sim | official_alignment_subset | 20 | 18 | 0.9 | 5 | 0 | 0.0 |  |
| V1_wrapper_official_parity | official_aligned_sim | official_alignment_subset | 20 | 19 | 0.95 | 5 | 0 | 0.0 |  |
...
| V4_no_method_specific_scene_edits | official_aligned_sim | official_alignment_subset | 20 | 18 | 0.9 | 0 | 0 | 0.0 |  |
...
| official_aligned subset parity | Supported but reproducibility-limited | Use to judge whether our wrapper is implementation-aligned with the public release on an official subset. | Parity status=reproducibility-limited parity; V0a vs V0b mismatches=3; V0a vs V1 mismatches=2; mismatch scene overlap=1. |
...
| --- | --- | --- | --- | --- | --- | --- |
| V1_wrapper_official_parity -> V2_shared_gripper | gripper_effect | 0.95 | 1.0 | 0.05 | 1 | moderate_effect |
| V2_shared_gripper -> V3_shared_success | success_rule_effect | 1.0 | 0.95 | -0.05 | 1 | moderate_effect |
| V3_shared_success -> V4_no_method_specific_scene_edits | scene_edit_effect | 0.95 | 0.9 | -0.05 | 1 | moderate_effect |
| V4_no_method_specific_scene_edits -> V5_track_a_cal_distribution | task_distribution_effect | 0.9 | 1.0 | 0.1 | 0 | distribution_shift_candidate |
...
- Gripper effect: `V1_wrapper_official_parity -> V2_shared_gripper` changes success rate by `+0.0500` and shows a moderate measurable impact.
...
- Method-specific scene-edit effect: `V3_shared_success -> V4_no_method_specific_scene_edits` changes success rate by `-0.0500` and shows a moderate measurable impact.
- Task/distribution effect: `V4_no_method_specific_scene_edits -> V5_track_a_cal_distribution` changes success rate by `+0.1000` and shows the strongest candidate bottleneck because the distribution changes.
