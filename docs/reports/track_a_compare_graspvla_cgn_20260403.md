...
- Parent runs:
  ...
  - `20260403_094028_cgn_track_a_v1_shared_sim`
- Track B reference:
...
| `cgn` | `language_conditioned_single_target_pick` | 25 | 0.0 | 3.0 | 0.0 | 81.2834 |
| `cgn` | `arbitrary_grasping_transparent` | 4 | 0.0 | 3.0 | 0.0 | 71.8441 |
