...
class PaperBundleTest(unittest.TestCase):
    ...
    def test_paper_bundle_writes_extended_outputs(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            self.assertIn("Simulation Summary", summary_text)
            self.assertIn("shared benchmark + protocol audit", summary_text)
            self.assertIn("Main Shared Grasping Benchmark", summary_text)
