...
def _build_probe_script(cluster_config: dict) -> str:
    ...
    all_bins = cluster_config["required_bins"] + cluster_config["optional_bins"]
    lines = [
        "set +e",
